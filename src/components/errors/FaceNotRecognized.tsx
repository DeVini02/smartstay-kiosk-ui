...
export const FaceNotRecognized = ({
  ...
  <div className="flex-1 flex flex-col items-center text-center pt-6 px-2">
    ...
    <p className="text-body text-text-secondary mt-2 max-w-[300px]">
      Pode ser a iluminação ou o ângulo do rosto. Sem problema, vamos por
      outro caminho.
    </p>
    ...
    <div className="flex flex-col gap-3 w-full mt-auto pt-6">
      <PrimaryButton onClick={onUseCode}>Usar código da reserva</PrimaryButton>
      <GhostButton onClick={onReception}>Falar com a recepção</GhostButton>
      <p className="text-mono-tiny text-text-tertiary text-center mt-1">
        {errorCode}
      </p>
    </div>
  </div>
